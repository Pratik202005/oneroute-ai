...
function AnimatedCounter({ target, prefix = '', suffix = '', duration = 2000 }) {
  ...
  return (
    <div ref={ref} className="text-center">
      <div
        className={`text-xl font-headline font-extrabold text-[#14B8A6] transition-transform duration-300 ${
          ...
          <div className="lg:col-span-5 flex flex-col space-y-6 lg:space-y-8 pt-4 lg:pt-0">
            ...
            <div className="grid grid-cols-2 gap-3 sm:gap-4">
              <div className="p-4 sm:p-6 rounded-2xl bg-white/8 border border-white/12 backdrop-blur-xl flex flex-col gap-2 sm:gap-3 hover:bg-white/10 transition-all">
                ...
                <div>
                  <h3 className="font-headline font-bold text-white text-sm sm:text-base">
                    Cut transport costs
                  </h3>
          ...
          <div className="lg:col-span-7 flex justify-center lg:justify-end">
            <div className="w-full max-w-xl p-6 sm:p-8 lg:p-12 rounded-3xl border border-white/12 bg-white/8 backdrop-blur-2xl shadow-[0px_32px_80px_rgba(0,0,0,0.35)] relative overflow-hidden">
              ...
              <div className="relative z-10 space-y-6 sm:space-y-8">
                <header>
                  <h2 className="text-xl sm:text-2xl font-headline font-extrabold text-white">
                    Initiate New Route
                  </h2>
                  <p className="text-white/70 font-label text-xs sm:text-sm">
                ...
                <form className="space-y-4 sm:space-y-6" onSubmit={handleSubmit}>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                    <div className="space-y-2">
                      <label className="text-xs font-bold uppercase tracking-widest text-white/65">
                        Product Name
                      </label>
                      <input
                        type="text"
                        ...
                        className={`w-full h-12 sm:h-14 px-4 sm:px-5 rounded-xl bg-white/10 border border-white/15 outline-none transition-all duration-300 text-white placeholder:text-white/40 text-sm ${
                          errors.product ? 'ring-2 ring-red-400' : 'focus:ring-2 focus:ring-[#14B8A6]/35'
                        }`}
                      />
                      {errors.product && <p className="text-xs text-red-200 font-medium">{errors.product}</p>}
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        min="1"
                        className={`w-full h-12 sm:h-14 px-4 sm:px-5 rounded-xl bg-white/10 border border-white/15 outline-none transition-all duration-300 text-white placeholder:text-white/40 text-sm ${
                          errors.quantity ? 'ring-2 ring-red-400' : 'focus:ring-2 focus:ring-[#14B8A6]/35'
                        }`}
                      />
                      {errors.quantity && <p className="text-xs text-red-200 font-medium">{errors.quantity}</p>}
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <span className="material-symbols-outlined absolute left-4 top-3 sm:top-4 text-white/50 text-base sm:text-lg">
                        location_on
                      </span>
                      <input
                        type="text"
                        ...
                        className={`w-full h-12 sm:h-14 pl-11 sm:pl-12 pr-4 sm:pr-5 rounded-xl bg-white/10 border border-white/15 outline-none transition-all duration-300 text-white placeholder:text-white/40 text-sm ${
                          errors.source ? 'ring-2 ring-red-400' : 'focus:ring-2 focus:ring-[#14B8A6]/35'
                        }`}
                      />
                    </div>
                    {errors.source && <p className="text-xs text-red-200 font-medium">{errors.source}</p>}
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`w-full h-12 sm:h-14 pl-11 sm:pl-12 pr-4 sm:pr-5 rounded-xl bg-white/10 border border-white/15 outline-none transition-all duration-300 text-white placeholder:text-white/40 text-sm ${
                          errors.destination ? 'ring-2 ring-red-400' : 'focus:ring-2 focus:ring-[#14B8A6]/35'
                        }`}
                      />
                    </div>
                    {errors.destination && <p className="text-xs text-red-200 font-medium">{errors.destination}</p>}
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      value={formData.time}
                      onChange={handleChange}
                      className="w-full h-12 sm:h-14 px-4 sm:px-5 rounded-xl bg-white/10 border border-white/15 outline-none transition-all duration-300 text-white text-sm focus:ring-2 focus:ring-[#14B8A6]/35"
                    />
                  </div>
                ...
                <div className="pt-6 sm:pt-8 border-t border-white/10 grid grid-cols-3 gap-2 sm:gap-4">
                  <div className="text-center">
                    ...
                    <div className="text-[9px] sm:text-[10px] font-label uppercase tracking-tighter text-white/60 mt-1">
                      Routes Optimized
                    </div>
                  </div>
                  <div className="text-center">
